...
LootJS.modifiers(event => {
    ...
    event.addLootTableModifier('minecraft:chests/simple_dungeon')
        .addWeightedLoot([
            ...
            Item.of("3x gtceu:source_imbued_steel_ingot").withChance(12)
        ]);
    ...
    event
        ...
        .addWeightedLoot([
            ...
            Item.of("gtceu:terrasteel_wire_cutter_head").withChance(0.15),
            Item.of("gtceu:terrasteel_drill_head").withChance(0.15),
            Item.of("gtceu:terrasteel_wrench_tip").withChance(0.15),
            Item.of("gtceu:terrasteel_mining_hammer").withChance(0.5),
        ...
        .addWeightedLoot([
            ...
            Item.of("minecraft:jukebox").withChance(6/100*100),
            Item.of("gtceu:terrasteel_wire_cutter_head").withChance(0.5),
            Item.of("gtceu:terrasteel_drill_head").withChance(0.5),
            Item.of("gtceu:terrasteel_wrench_tip").withChance(0.5),
            Item.of("gtceu:terrasteel_mining_hammer").withChance(0.5),
            ...
            Item.of("8x integrateddynamics:cable").withChance(1),
        ...
        .addWeightedLoot([
            ...
            Item.of("gtceu:alfsteel_mining_hammer").withChance(0.15),
            ...
            Item.of("gtceu:machine_controller_cover").withChance(2),
            Item.of("gtceu:ender_restone_link_cover").withChance(2),
            Item.of("gtceu:lumium_wire").withChance(3),
            ...
            Item.of("1x artifacts:plastic_drinking_hat").withChance(1),
            Item.of("2x functionalstorage:copper_upgrade").withChance(3),
            Item.of("2x integrateddynamics:part_interface_item").withChance(1),
