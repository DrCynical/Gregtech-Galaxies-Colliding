ServerEvents.recipes(event => {
    ...
    //Livingwood
     event.remove({id: 'botania:pure_daisy/livingwood_log'})
     event.custom({
        type: "botania:pure_daisy",
        input: {
            type: "block",
    ...
    event.recipes.gtceu.vacuum_freezer('cool_terrasteel')
        .itemInputs('gtceu:hot_terrasteel_ingot')
   ...
   // event.recipes.gtceu.essence_reactor('elementium_what')
    ...
    event.recipes.gtceu.distillery('mana_condensation')
        ...
        .outputFluids('gtceu:refined_mana 100')
        .duration(20)
        .EUt(64)
