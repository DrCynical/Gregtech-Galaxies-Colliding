...
ServerEvents.recipes(event => {
  ...
  event.recipes.gtceu.forming_press("t1_welded_plate")
    .itemInputs(['4x gtceu:black_steel_plate', '4x gtceu:terrasteel_plate', '4x gtceu:stainless_steel_plate', '4x gtceu:manasteel_plate'])
    .circuit(1)
  ...
  event.recipes.gtceu.forming_press("t2_welded_plate")
    .itemInputs(['4x gtceu:alfsteel_plate', '4x gtceu:tungsten_steel_plate', '4x gtceu:thorium_plate', '4x gtceu:iesnium_plate'])
    .circuit(1)
  ...
  event.recipes.gtceu.assembler("space_suit_t1")
    .itemInputs(['32x gtceu:polytetrafluoroethylene_plate', '4x gtceu:stainless_steel_plate', '4x gtceu:manasteel_plate', 'ad_astra:gas_tank'])
    .circuit(1)
    .itemOutputs('ad_astra:space_suit')
    .duration(160)
    .EUt(GTValues.VA[GTValues.HV]);
  event.recipes.gtceu.assembler("space_helmet_t1")
    .itemInputs(['20x gtceu:polytetrafluoroethylene_plate', '3x gtceu:stainless_steel_plate', '3x gtceu:manasteel_plate', 'gtceu:glass_plate'])
    .circuit(1)
    .itemOutputs('ad_astra:space_helmet')
    .duration(160)
    .EUt(GTValues.VA[GTValues.HV]);
  event.recipes.gtceu.assembler("space_pants_t1")
    .itemInputs(['28x gtceu:polytetrafluoroethylene_plate', '4x gtceu:stainless_steel_plate', '4x gtceu:manasteel_plate'])
    .circuit(2)
    .itemOutputs('ad_astra:space_pants')
    .duration(160)
    .EUt(GTValues.VA[GTValues.HV]);
  event.recipes.gtceu.assembler("space_boots_t1")
    .itemInputs(['16x gtceu:polytetrafluoroethylene_plate', '1x gtceu:stainless_steel_plate', '1x gtceu:manasteel_plate'])
    .circuit(3)
    .itemOutputs('ad_astra:space_boots')
    .duration(160)
    .EUt(GTValues.VA[GTValues.HV]);
  event.recipes.gtceu.assembler("launch_pad")
    .itemInputs(['6x gtceu:stainless_steel_plate', '3x gtceu:terrasteel_plate'])
    .circuit(5)
  ...
  event.recipes.gtceu.assembler('osmiridium_nose_cone')
    .itemInputs(['8x gtceu:double_osmiridium_plate', '4x gtceu:osmiridium_rod', '#gtceu:circuits/luv'])
    .circuit(15)
