ServerEvents.recipes(event => {
    ...
    [
        ...
        {id: 'uranium_235', rod: 'enriched_uranium', input: ['4x gtceu:uranium_235_dust'], output: ['4x gtceu:plutonium_241_dust'], duration: 300, energy: 1536, harvest: -16384},
        {id: 'uranium_238', rod: 'poor_uranium', input: ['4x gtceu:uranium_dust'], output: ['4x gtceu:plutonium_dust'], duration: 240, energy: 1280, harvest: -12288}
    ].forEach(rod=> {
