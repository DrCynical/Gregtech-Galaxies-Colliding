GTCEuStartupEvents.registry('gtceu:machine', event => {
    event.create("mana_matic", "multiblock")
        .rotationState(RotationState.NON_Y_AXIS)
        .recipeTypes("mana_matic")
        ...
        .pattern(definition => FactoryBlockPattern.start()
            ...
            .aisle("FCCCF", "FCCCF", "FAAAF")
            .aisle("CLLLC", "CAAAC", "AAAAA")
            .aisle("CLLLC", "CAAAC", "AAAAA")
            .aisle("CLLLC", "CAAAC", "AAAAA")
            .aisle("FC@CF", "FCCCF", "FAAAF")
            ...
            .where("L", Predicates.blocks(Block.getBlock("botania:livingrock")))
